                ...
                @endif
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="{{url('/back/permission/create')}}" class="btn btn-primary pull-right">Create Permission</a>
                        </div>
                        <div class="card-body">
                  <table id="bootstrap-data-table" class="table table-striped table-bordered">
                    ...
                    @foreach($data as $i=>$row)
                      <tr>
                        ...
                        <td>
                            <a href="{{url('back/permission/delete/'.$row->id)}}" class="btn btn-primary pull-right mx-2">Delete</a>
                            <a href="{{url('back/permission/edit/'.$row->id)}}" class="btn btn-primary pull-right">Edit</a>
                        </td>
                      </tr>
                    @endforeach  
                    </tbody>
