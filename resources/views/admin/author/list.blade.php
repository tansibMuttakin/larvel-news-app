                ...
                @endif
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Auhtor List</strong>
                            
                            <a href="{{url('/back/author/create')}}" class="btn btn-primary pull-right">Create Author</a>
                  ...
                  <table id="bootstrap-data-table" class="table table-striped table-bordered">
                    ...
                    @foreach($data as $i=>$row)
                      <tr>
                        ...
                        <td>
                            <a href="{{url('back/author/delete/'.$row->id)}}" class="btn btn-danger pull-right mx-2">Delete</a>
                            <a href="{{url('back/author/edit/'.$row->id)}}" class="btn btn-primary pull-right">Edit</a>
                        </td>
                      </tr>
                    @endforeach  
                    </tbody>
