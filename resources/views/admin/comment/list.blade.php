                            ...
                            <div class="card-body">
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if($row->status === 1)
                                            <a href="{{url('back/comment/status/'.$row->id)}}" class="btn btn-success pull-right mx-2">Published</a>
                                            @else
                                            <a href="{{url('back/comment/status/'.$row->id)}}" class="btn btn-warning pull-right mx-2">Unpublished</a>
                                            @endif
                                        </td>
                                        <td>
                                            <a href="{{url('back/comment/reply/'.$row->post_id)}}" class="btn btn-info pull-right mx-2">Reply</a> 
                                        </td>
                                    </tr>
                                    @endforeach  
                                    </tbody>
